...
const charbotToggler = document.querySelector("#chatbot-toggler");
const closeChatbot = document.getElementById("close-chatbot");

const API_KEY = "AIzaSyDKZQmG9dwn49vXTFV8Ru7_U__mc4bLkEg";
...
const handleOutgoingMessages = (e) =>{
    ...
    setTimeout(()=>{
        const messageContent = `<svg xmlns="http://www.w3.org/2000/svg" class="bot-avatar" width="50" height="50" viewBox="0 0 1024 1024">
...
charbotToggler.addEventListener("click", ()=>
